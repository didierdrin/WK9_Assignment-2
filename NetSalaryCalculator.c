...
float calculateMedication(float *grossSalary) { return *grossSalary * 0.05; }

// Function to calculate maternity leave
float calculateMaternity(float *grossSalary) { return *grossSalary * 0.003; }
...
int main() {
  ...
  if (grossSalary < 0) {
    printf("Invalid input! Please enter a valid positive number for gross "
           "salary.\n");
    return 1;
  }
